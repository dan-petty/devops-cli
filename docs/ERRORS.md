...
| `DEVOPS_CLI_ERROR` | `1` | Ai | Base exception for documentation ingestion errors. |
...
| `DEVOPS_CLI_ERROR` | `1` | Ai | Base exception for package introspection and library ingestion errors. |
| `DEVOPS_CLI_ERROR` | `1` | Ai | Raised when target package cannot be imported or found in the environment. |
