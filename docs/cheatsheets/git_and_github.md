...
| :--- | :--- | :--- | :--- |
| **Create Release-Targeted PR** | `gh pr create --base release/v0.2.0 --head feat/my-feature` | `devops pr create --title "feat: ..." --body "..."` | Auto-detects active release branch target, generates changelog summary, and verifies pre-commit hooks. |
