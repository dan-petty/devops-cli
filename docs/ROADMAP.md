...
- [ ] **Synthetic Defect Corpora for Review Evaluation (P1 - High)**:
...
- [ ] **Review Performance Baseline: Per-Stage Timing, Calls and Tokens on a Fixed Corpus (P1 - High, Issue #473)**:
...
- [ ] **LLM Gateway Calls Record Their Serving Backend in the Spend Ledger (P1 - High, Issue #474)**:
...
- [ ] **LLM Gateway Weights Validated Against Real Reviews (P2 - Medium, Issue #476)**:
