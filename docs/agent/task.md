...
| [#140](https://github.com/dan-petty/devops-cli/issues/140) | TBD | Add release notes extraction fallback and enforce changelog version check | `In Progress` | [`task-140-release-notes-extraction-fallback-and-changelog-check.md`](tasks/task-140-release-notes-extraction-fallback-and-changelog-check.md) |
