...
| [#110](https://github.com/dan-petty/devops-cli/issues/110) | TBD | Streaming diagnostic log aggregator and panic detector (`devops sandbox logs`) | `In Progress` | [`task-110-sandbox-logs-panic-detector.md`](tasks/task-110-sandbox-logs-panic-detector.md) |
