...
| [#176](https://github.com/dan-petty/devops-cli/issues/176) | TBD | Remediate DevSecOps review findings & enhance review self-improvement loop | `In Progress` | [`task-176-review-findings-self-improvement.md`](tasks/task-176-review-findings-self-improvement.md) |
