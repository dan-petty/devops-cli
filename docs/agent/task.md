...
| [#188](https://github.com/dan-petty/devops-cli/issues/188) | [#187](https://github.com/dan-petty/devops-cli/pull/187) | Gate pull request workflow on unresolved review threads and merge blockers | `In Review` | [`task-188-ci-pr-merge-readiness-workflow-gate.md`](tasks/task-188-ci-pr-merge-readiness-workflow-gate.md) |
