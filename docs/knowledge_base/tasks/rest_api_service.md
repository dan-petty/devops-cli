...
- **DevOps CLI Server Factory**: [src/devops_cli/server/app.py](../../../src/devops_cli/server/app.py)
- **Serve Command Module**: [src/devops_cli/commands/serve.py](../../../src/devops_cli/commands/serve.py)
