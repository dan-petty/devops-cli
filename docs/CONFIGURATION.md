...
| `rag` | `AIRAGConfig` | `enabled=True embedding_model='qwen3-embedding:0.6b' embedding_url=None embedding_timeout=15.0 top_k=5 score_threshold=0.35 chunk_size=2400 chunk_overlap=240` | - | - |
