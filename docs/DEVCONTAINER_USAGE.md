...
| `vX.Y.Z` | `ghcr.io/dan-petty/devops-cli/devcontainer:v0.2.7` | Immutable, pinned version | CI pipelines & reproducible environments |
...
docker pull ghcr.io/dan-petty/devops-cli/devcontainer:v0.2.7
```
...
devops devcontainer init --name my-project --image ghcr.io/dan-petty/devops-cli/devcontainer:v0.2.7
```
