...
def test_rich_formatters() -> None:
    ...
    assert format_duration(9.94) == "9.94s"
    assert format_duration(10.0) == "10s"
    assert format_duration(10.4) == "10s"
    assert format_duration(10.6) == "11s"
    assert format_duration(12.55) == "13s"
    assert format_duration(45.73) == "46s"
    assert format_duration(55.0) == "55s"
    ...
    assert format_duration(92.27) == "1m 32s"
    assert format_duration(120.0) == "2m"
    assert format_duration(163.37) == "2m 43s"
    assert format_duration(166.68) == "2m 47s"
