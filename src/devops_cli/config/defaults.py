...
DEFAULT_VLLM_MODEL: str = "Qwen/Qwen2.5-Coder-32B-Instruct-AWQ"
DEFAULT_VLLM_SERVED_MODEL_NAME: str = "qwen2.5-coder-32b-instruct"
DEFAULT_VLLM_SINGLE_CLUSTER_URL: str = "http://vllm-single.llm.svc.cluster.local:8000/v1"
...
DEFAULT_AI_DURABLE_WORKFLOW_PREFIX: str = "devops-run-"
...
DEFAULT_RAG_LIBRARIES_COLLECTION = "devops_libraries"
DEFAULT_VALKEY_SYMBOL_TTL_SECONDS = 604800  # 7 days TTL for cached symbol signatures
