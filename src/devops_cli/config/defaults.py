...
DEFAULT_DOC_CHUNK_SIZE_WORDS: int = 100
DEFAULT_DOC_CHUNK_OVERLAP_WORDS: int = 20
DEFAULT_DOC_MIN_CHUNK_WORDS: int = 25
...
DEFAULT_RAG_MAX_CHARS: int = 15000
DEFAULT_RAG_INVESTIGATION_MAX_CHARS: int = 12000
DEFAULT_RAG_MAX_PER_FILE: int = 4
...
DEFAULT_BANDIT_EXCLUDE_TESTS: str = "B608"
DEFAULT_PROMPT_CAP_CHARS: int = 6000
...
DEFAULT_KUBERNETES_NAMESPACE: str = "default"
DEFAULT_OBSERVABILITY_NAMESPACE: str = "observability"
DEFAULT_K8S_OBSERVABILITY_NAMESPACE: str = "observability"
DEFAULT_K8S_STACK: str = "infra"
DEFAULT_K8S_STACK_INFRA: str = "infra"
DEFAULT_K8S_ALL_STACK: str = "all"
DEFAULT_K8S_STACK_ALL: str = "all"
DEFAULT_K8S_TLS_SECRET_NAME: str = "homelab-tls"
DEFAULT_TLS_SECRET_NAME: str = "homelab-tls"
...
DEFAULT_RELEASE_LABELS: str = "release"
DEFAULT_CLEAN_WORKSPACE_DAYS: int = 7
DEFAULT_CLEANUP_OLDER_THAN_DAYS: int = 7
DEFAULT_GIT_LOG_COUNT: int = 10
DEFAULT_FIND_MAXDEPTH: int = 3
DEFAULT_FIND_MAX_DEPTH: int = 3
