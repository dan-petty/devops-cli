...
_SECRET_PATTERNS: tuple[tuple[re.Pattern[str], str], ...] = (
    (
        re.compile(
            r"\b(?:ghp_[A-Za-z0-9_]{10,}|gho_[A-Za-z0-9_]{10,}|github_pat_[A-Za-z0-9_]{20,})"
        ),
        "<masked-github-token>",
    ),
    (
    ...
    (re.compile(r"\bsk-ant-[A-Za-z0-9_-]{20,}"), "<masked-anthropic-key>"),
    (re.compile(r"\bsk-[A-Za-z0-9_-]{20,}"), "<masked-openai-key>"),
