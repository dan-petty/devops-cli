...
1. **Universal Standards & Target Context**: Evaluate source files against universal software engineering principles (OWASP Top 10, CIS benchmarks, SOLID, Clean Code) and the target project's declared conventions (e.g. `AGENTS.md`, `CLAUDE.md`, `CONTRIBUTING.md`, or project documentation) without imposing host tool layout or tooling assumptions. Identify genuine defects, maintainability risks, and security flaws in the target codebase.
