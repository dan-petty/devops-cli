...
- **Actionable Remediation & Invariants**: Provide drop-in, minimal code fixes in the `fix` field that satisfy project architectural invariants: cyclomatic complexity $\le 10$ and maximum nesting depth $\le 5$.
