...
1. **Universal Standards & Target Context**: Evaluate changes against universal software engineering principles (OWASP Top 10, CIS benchmarks, SOLID, Clean Code) and the target project's declared conventions (e.g. `AGENTS.md`, `CLAUDE.md`, `CONTRIBUTING.md`, or project documentation). Avoid enforcing external project layouts or host tool assumptions onto target codebases.
