...
6. **Contextual & Educational Documentation**: Do not flag documentation, tutorials, architectural guides, or prompt benchmarks describing known vulnerabilities or insecure configurations in the context of avoiding or mitigating them.
