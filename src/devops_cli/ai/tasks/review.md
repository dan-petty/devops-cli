...
- **Algorithmic Complexity & Resource Protection (CWE-400)**: Identify $O(N^2)$ repetitive AST unparsing, string serialization, or token counting inside loops. Enforce linear $O(N)$ budgeting with single-pass calculation.
