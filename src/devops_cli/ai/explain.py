...
_BENCHMARK_SECTIONS: list[dict[str, Any]] = [
    {
        ...
        "items": [
            (
                "Recall@1 (%)",
                ("Percentage of queries where the exact target passage was retrieved at rank 1."),
            ...
            (
                ...
                ("Formula: DCG@5 / IDCG@5 where DCG = sum(rel_i / log2(i + 1)). Target: >= 0.90"),
            ),
            (
                "Cosine Margin",
                (
                ...
                ("Formula: sim(query, target) - max(sim(query, distractor)). Target: > +0.15"),
            ),
            (
                "Separation Score",
                (
    ...
    },
    {
        ...
        "items": [
            ...
            (
                ...
                ("Batch indexing speed across the corpus passages. Measures indexing throughput."),
...
_REVIEW_SECTIONS: list[dict[str, Any]] = [
    {
        ...
        "items": [
            ...
            (
                ...
                ("Focus: Test isolation, mocking external I/O, error paths, flake prevention"),
            ),
            (
                "PM Persona",
                (
                ...
                ("Focus: SemVer compliance, changelog clarity, CLI UX, backward compatibility"),
            ),
            (
                "Auditor Persona",
                (
    ...
    },
    {
        ...
        "items": [
            ...
            (
                "LOW / INFO",
                ("Code style improvement, documentation typo, or minor refactoring suggestion."),
...
_ANALYZE_SECTIONS: list[dict[str, Any]] = [
    {
        ...
        "items": [
            ...
            (
                ...
                ("High Fan-In indicates critical shared libraries; high Fan-Out is high risk"),
            ),
            (
                "AST Syntax Scanning",
                (
...
_RAG_SECTIONS: list[dict[str, Any]] = [
    {
        ...
        "items": [
            (
                ...
                ("Preserves symbol context, import dependencies, and docstrings in each chunk"),
            ),
            (
            ...
            (
                ...
                ("Grounds model responses in actual codebase architecture and specifications"),
            ),
            (
